...
public class SwaggerConfig {
    ...
    @Value("${documentation.generate.URL}")
    private String docGenerateURL;
    ...
    public UiConfiguration uiConfig() {
        return new UiConfiguration(
                null, DOC_EXPANSION, "alpha", "schema",false, true
        );
    }
    ...
    private ApiInfo metaData() {
        ...
        remremDescription.append("<a href= " + docGenerateURL + ">REMReM Generate documentation</a>");
